...
const char* ssid1 = "Davinci";
const char* password1 = "shiwoya132";
...
void setup() 
{
  WRITE_PERI_REG(RTC_CNTL_BROWN_OUT_REG, 0); // prevent brownouts by silencing them 通过沉默来限制电压
  ...
  //下拉帧大小以提高初始帧速率 (drop down frame size for higher initial frame rate)

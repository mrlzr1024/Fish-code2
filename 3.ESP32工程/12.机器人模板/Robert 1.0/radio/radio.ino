/*
   ...
   @LastEditTime: 2022-03-10 07:51:03
...
<iframe loading="lazy" src="\cam" width="800" height="600"></iframe>
<script>
function stoping(){
	window.stop();};
</script>
...
<p>
<a href = "/off">
<button class = "button2" onclick=stoping()>ON</button>
</a>
</p>)EOT";
...
<!iframe loading="lazy" src="\cam" width="800" height="600">
<script>
function stoping(){
	window.stop();};
</script>
...
<p>
<a href = "/on">
<button class = "button" onclick=stoping()>OFF</button>
</a>
</p>)EOT";
/*=============================================================================*/
/*=============================================================================*/
const int buff = sizeof(FR_init) + sizeof(FR_off);

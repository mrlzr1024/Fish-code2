    ...
    <section id="buttons">
        ...
        <div id="sliders" class="slider-container">
            <table>
                <tr>
                    <td>俗度:</td>
                    <td align="center" colspan="2"><input type="range" id="speed" min="0" max="100" value="100"
                            onchange="try{fetch(document.location.origin+'/control?var=speed&val='+this.value);}catch(e){}">
                    </td>
                </tr>
                <tr>
                    <td>转向:</td>
                    <td align="center" colspan="2"><input type="range" id="speed" min="0" max="1000" value="200"
                            onchange="try{fetch(document.location.origin+'/control?var=delay&val='+this.value);}catch(e){}">
                    </td>
                </tr>
                <tr>
                    <td>X轴:</td>
                    <td align="center" colspan="2"><input type="range" id="speed" min="0" max="180" value="90"
                            onchange="try{fetch(document.location.origin+'/control?var=engine_x&val='+this.value);}catch(e){}">
                    </td>
                </tr>
                <tr>
                    <td>Y轴:</td>
                    <td align="center" colspan="2"><input type="range" id="speed" min="0" max="180" value="90"
                            onchange="try{fetch(document.location.origin+'/control?var=engine_y&val='+this.value);}catch(e){}">
                    </td>
                </tr>
                <tr>
                    <td>质量:</td>

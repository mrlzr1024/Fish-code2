...
// #define SDA_PIN 4                           // SDA引脚，默认gpi.o4(D2)
...
char data_buf_1 = 0x00;
char data_buf_2 = 0x00;

void RTC_Init()
{
    if (!at24c02_read(&data_buf_1, 0x03) &&
        !at24c02_read(&data_buf_2, 0x04))
    {
        Loop.year = data_buf_1 * 100 + data_buf_2;
    }
    if (!at24c02_read(&data_buf_1, 0x05))
    {
        Loop.mounth = data_buf_1;
    }
    if (!at24c02_read(&data_buf_1, 0x06))
    {
        Loop.day = data_buf_1;
    }
    if (!at24c02_read(&data_buf_1, 0x07))
    {
        Loop.hour = data_buf_1;
    }
    if (!at24c02_read(&data_buf_1, 0x08))
    {
        Loop.minuse = data_buf_1;
    }
}
...
//     {
//         Serial.print("Read at24c02 in 0x03, data is");

...
//			key=key4x4(); //矩阵键盘识别
			...
			/*=============================================================================*/
			/*key=4~5相应模式(on)*/if(key==4&&swich==1){a=moves1(4,a,mode);}//正转
			else if(key==5&&swich==1){a=moves1(5,a,mode);}//反转
			/*=============================================================================*/
			/*key=4~5不相应模式(off)*/if(key==4&&swich==0){a+=50;if(a>2000){a=2000;}}//正转
			...
			/*=============================================================================*/
			if(key==9){fill_picture(0x00);	display(0,0,di_abcd,67);}//key==9时清屏//就绪标志//==========显示-'on'(0,0)
		}
		}			

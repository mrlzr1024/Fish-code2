 ...
 * @LastEditTime: 2022-04-14 18:46:18
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \小车\TuringServo.c
 */
 ...
 * 备注：步进=50*1us
 * *************************************************/
int moves1(int mod1, int angle1, int mode1)
{ // mod1--4逆时针 5--顺时针 angle--转的角度 mode--哪位舵机
    int i = 0;
    switch (mod1)
    {
    case 4:

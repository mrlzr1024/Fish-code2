/*--------------------------------------------------------------*/
//ICC-AVR application builder : 2009-8-5 18:01:10
// Target : M8
// Crystal: 1.000Mhz
/*--------------------------------------------------------------*/
...
#include <iom8v.h>
#include <macros.h>
#include "ICCAVRIO.H"		//AVR IO口位操作
#include "LCD5510_V3.H"


/*--------------------------------------------------------------*/
const unsigned char *str1 = {"Nokia 5510 Test, Haha ^_^ I am so glad to see you agian! Do you think so?"};
const unsigned char *str2 = {"I Love You AVR"};
...
const unsigned char pic1[] = {//72*14
...
const unsigned char pic2[] = {//72*28
...
void delay50ms(void)
{
	...
	do{i = 249; do{i--;}while(i); j--;}while(j);
}

//延时200000-1us 函数定义
void delay200ms(void)
{
	unsigned char x, y, z = 78;
	do{y = 160; do{x = 3; do{x--;}while(x); y--;}while(y); z--;}while(z);
}
...
void delay1s(void)
{
	unsigned char x, y, z = 98;
	do{y = 255; do{x = 9; do{x--;}while(x); y--;}while(y); z--;}while(z);
}
